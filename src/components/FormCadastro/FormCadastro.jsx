...
const FormCadastro = () => {
  ...
  const ModalErro = () => {
    return <p className={styles.cadastroErro}>Erro ao cadastrar usuário!</p>;
  };
  const ModalOk = () => {
    return (
      <p className={styles.cadastroFeito}>Usuário cadastrado com sucesso!</p>
    );
  };
  return (
    <>
      ...
      <div className={styles.caixaTransparente}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.caixaBotoes}>
            <Link to="/">
              <button className={styles.voltarLogin} type="submit">
                Voltar
              </button>
            </Link>
